...
struct chromosome_t thisChromosome = (struct chromosome_t) {
	{
	 {2, 1, 1, 1, 2, 1, 0.5, 4},	/*weight of every resource, value of Development Card, relative value of City (compared to equivalen Settlement) and Ports, when I have 0 Victory Points */
	 {1.5, 1, 1, 1, 1.5, 1, 0.5, 4},	/*when I have 1 */
	 {1, 1, 1, 1, 1, 1, 0.7, 9},	/*2 */
	 {1, 1.2, 1.2, 1.2, 1, 2, 0.8, 9},	/*3 */
	 {1, 1.3, 1.3, 1.3, 1, 2, 0.9, 10},	/*4 */
	 {1, 1, 1, 1, 1, 2, 1, 10},	/*5 */
	 {1, 1, 1, 1, 1, 2, 1, 10},	/*6 */
	 {1, 1, 1, 1, 1, 2, 1.1, 10},	/*7 */
	 {1, 1, 1, 1, 1, 2, 1.2, 10},	/*8 */
	 {1, 1, 1, 1, 1, 2, 1.3, 10},	/*9 */
	 },
	0.015, 5, 0.51		/*depreciation, turn and probability */
};				/*default chromosome */
