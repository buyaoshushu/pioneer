...
gboolean setup_check_road(const Edge * edge, gint owner);
gboolean setup_check_ship(const Edge * edge, gint owner);
gboolean setup_check_bridge(const Edge * edge, gint owner);
gboolean setup_check_settlement(const Node * node, gint owner);
