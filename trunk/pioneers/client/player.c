...
static GdkColor token_colors[] = {
	...
	{ 0, 0xff00, 0xa500, 0x0000 }, /* orange */
	{ 0, 0xff00, 0xff00, 0x0000 }, /* yellow */
	{ 0, 0x0000, 0xff00, 0xff00 }, /* cyan */
	{ 0, 0xff00, 0x0000, 0xff00 }, /* magenta */
	{ 0, 0x0000, 0x0000, 0xff00 }, /* blue */
	{ 0, 0xff00, 0xff00, 0xff00 }, /* white */
	{ 0, 0x0000, 0xff00, 0x0000 } /* green */
};
